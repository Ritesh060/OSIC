...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopkeeper Login || OSIC</title>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li><a href="contact.php">Contact</a></li>
          <li class="active"><a href="shopkeeper.php">Shopkeepers</a></li>
          <?php
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="something@gmail.com" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
