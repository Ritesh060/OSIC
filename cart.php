...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || OSIC</title>
      ...
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            $result = $mysqli->query("SELECT Shop_Name, product_name, product_desc, qty, price FROM products WHERE id = ".$product_id);
